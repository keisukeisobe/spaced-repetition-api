      ...
      it('inserts 1 language with words for the new user', () => {
        ...
        const expectedList = {
          ...
          words: [
            ...
            { original: 'happy', translation: 'felicidad' },
            { original: 'desk', translation: 'escritorio' },
            { original: 'computer', translation: 'computadora' },
            { original: 'great', translation: 'genial' },
            { original: 'indisputable', translation: 'indiscutible' },
            { original: 'paper', translation: 'papel' },
            { original: 'request', translation: 'solicitud' },
          ]
        };
        return supertest(app)
          .post('/api/user')
